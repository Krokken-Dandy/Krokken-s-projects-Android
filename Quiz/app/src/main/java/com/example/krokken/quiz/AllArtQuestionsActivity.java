...
public class AllArtQuestionsActivity extends AppCompatActivity {
    ...
    public void questionsArrayList() {
        ...
        questionsForArt.add(new Question(1, numbers[0], R.drawable.question_one_image,
        ...
        questionsForArt.add(new Question(3, numbers[1], R.drawable.question_two_image,
        ...
        // mainQuestion, answer1, answer2, answer3, answer4, answer5, and the correctAnswer
        questionsForArt.add(new Question(1, numbers[5], R.drawable.question_six_image,
        ...
        // mainQuestion, answer1, answer2, answer3, answer4, answer5, and the correctAnswer
        questionsForArt.add(new Question(1, numbers[6], R.drawable.question_seven_image,
        ...
        // mainQuestion, answer1, answer2, answer3, answer4, answer5, and the correctAnswer
        questionsForArt.add(new Question(1, numbers[7], R.drawable.question_eight_image,
        ...
        //        // correctAnswer2, correctAnswer3, correctAnswer4, correctAnswer5
        questionsForArt.add(new Question(3, numbers[8], questions[8], answersQ9[0],
